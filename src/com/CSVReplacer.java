...
public class CSVReplacer {
	...
	private static final String SERVIZI_PER_IL_TURISMO = "serviziTurismo";
	...
	public static final String CAMPO_ICON_CATEGORY = "CAMPO_ICON_CATEGORY";

	public static final String ARCHEOLOGIA = "Archeologia";
	public static final String ARTE_E_STORIA = "Arte e Storia";
	public static final String VACANZE_NELLA_NATURA = "Vacanze nella natura";
	public static final String PAESI_E_CULTURE = "Paesi e culture";
	public static final String LE_TRADIZIONI = "Le tradizioni";
	public static final String I_SAPORI = "I sapori";
	public static final String IL_MARE = "Il mare";
	public static final String LA_MONTAGNA = "La montagna";
	public static final String BENESSERE = "Benessere";

	public static final String iconArcheologiaArteEStoria = "[fusion_image image=\"https://www.molise-italia.it/wp-content/uploads/2019/10/Archeologia_arte_e_storia-e1574194179395.png\" image_id=\"6084|thumbnail\" link=\"\" linktarget=\"_self\" alt=\"\" /]";
	public static final String iconVacanzeNellaNatura = "[fusion_image image=\"https://www.molise-italia.it/wp-content/uploads/2019/07/Vacanze_nella_natura-e1574193238920.png\" image_id=\"3255|thumbnail\" link=\"\" linktarget=\"_self\" alt=\"\" /]";
	public static final String iconPaeseECulture = "[fusion_image image=\"https://www.molise-italia.it/wp-content/uploads/2019/10/Paese_e_culture-e1574194147226.png\" image_id=\"6083|thumbnail\" link=\"\" linktarget=\"_self\" alt=\"\" /]";
	public static final String iconLeTradizioni = "[fusion_image image=\"https://www.molise-italia.it/wp-content/uploads/2019/10/Le_tradizioni-150x150.png\" image_id=\"6085|thumbnail\" link=\"\" linktarget=\"_self\" alt=\"\" /]";
	public static final String iconISapori = "[fusion_image image=\"https://www.molise-italia.it/wp-content/uploads/2019/10/I_sapori-e1574193995857.png\" image_id=\"6078|thumbnail\" link=\"\" linktarget=\"_self\" alt=\"\" /]";
	public static final String iconIlMare = "[fusion_image image=\"https://www.molise-italia.it/wp-content/uploads/2019/10/Il_mare-e1574194063851.png\" image_id=\"6079|thumbnail\" link=\"\" linktarget=\"_self\" alt=\"\" /]";
	public static final String iconLaMontagna = "[fusion_image image=\"https://www.molise-italia.it/wp-content/uploads/2019/10/La_montagna-e1574194096676.png\" image_id=\"6080|thumbnail\" link=\"\" linktarget=\"_self\" alt=\"\" /]";
	public static final String iconBenessere = "[fusion_image image=\"https://www.molise-italia.it/wp-content/uploads/2019/10/Benessere_30x30.png\" image_id=\"7549|thumbnail\" link=\"\" linktarget=\"_self\" alt=\"\" /]";
	...
	public static void main(String[] args) throws IOException {
		...
		try (
			...
			for (All atr : csvToBean) {
				...
				for (FieldsAziendeRisorse fields : FieldsAziendeRisorse.values()) {
					if (!atr.getField(fields).equals("-")) {
						if (fields.name().contains(FieldsAziendeRisorse.CAMPO_TELEFONO.name()) || fields.name().contains(FieldsAziendeRisorse.CAMPO_INDIRIZZO.name())) {
							stringToReplace = stringToReplace.replaceAll(fields.name(), atr.getField(fields) + "\n");
						} else if (fields.name().contains(FieldsAziendeRisorse.CAMPO_TIPOLOGIA.name())) {
							stringToReplace = stringToReplace.replace(FieldsAziendeRisorse.CAMPO_TIPOLOGIA.name(), atr.getField(fields));
...
//							}
						} else if (fields.name().contains(FieldsAziendeRisorse.CAMPO_CATEGORIA.name())) {
